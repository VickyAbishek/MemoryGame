...
class MemoryBoardAdapter(
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        ...
        val cardHeight: Int = parent.height / boardSize.getHeigth() - ( 2 * MARGIN_SIZE )
    ...
    inner class ViewHolder(itemView: View): RecyclerView.ViewHolder(itemView) {
        ...
        fun bind(position: Int) {
            ...
            val colorStateList = if ( memoryCard.isMatched ) ContextCompat.getColorStateList(context, R.color.material_on_background_disabled ) else null
